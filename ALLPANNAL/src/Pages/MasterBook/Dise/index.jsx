        ...
        <div className="container-fluid">
          ...
          <div className="card bg-info-subtle shadow-none position-relative overflow-hidden mb-md-4 mb-3">
            <div className="card-body d-flex align-items-md-center justify-content-between p-md-4 p-3 flex-md-row flex-column">
              <h5 className="fw-bold mb-0">Sic Bo</h5>
          ...
          <div className="row">
            <div className="col-md-8">
              <iframe
                ...
                frameBorder="0"
              ></iframe>
              <div className="mb-5 mt-2 dise-game">
                    ...
                    <div className="bg-light rounded p-2 mb-3">
                      <div className="row custom-row">
                        ...
                        <div className="col-2 custom-col text-center">
                          <p></p>
                          {/* <img
                            src="https://indiaexch7.com/img/cards/andar_bahar/7.jpg"
                            width={50}
                            alt=""
                          /> */}
                        </div>
                    ...
                    <div className="bg-light rounded p-2 mb-0">
                      ...
                      <div className="text-center card-seven">
                        <div className="card-image showbet-action">
                          <div className="">
                            <img
                              src="https://indiaexch7.com/img/dice/SicBo/3.png"
                              width={"45px"}
                            />
                          </div>
                        ...
                        <div className="card-image showbet-action">
                          <div className="">
                            <img
                              src="https://indiaexch7.com/img/dice/SicBo/4.png"
                              width={"45px"}
                            />
                          </div>
                          <div className="ubook text-danger">
                        ...
                        <div className="card-image showbet-action">
                          <div className="">
                            <img
                              src="https://indiaexch7.com/img/dice/SicBo/5.png"
                              width={"45px"}
                            />
                          </div>
                          <div className="ubook text-danger">
                        ...
                        <div className="card-image showbet-action">
                          <div className="">
                            <img
                              src="https://indiaexch7.com/img/dice/SicBo/6.png"
                              width={"45px"}
                            />
                          </div>
                          <div className="ubook text-danger">
