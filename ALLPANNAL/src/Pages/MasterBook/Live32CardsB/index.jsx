                ...
                <div className="row">
                  ...
                  <div className="col-12">
                    <div className="table-responsive">
                      <table className="table s-100 table-bordered">
                        <tbody id="poker-numbers" className="suspended">
                          <tr>
                            <th colSpan={5} className="text-center card-odds">
                              0.00
                            </th>
                          </tr>
                          <tr className="back bet-info" id="poker-number1">
                            <td className="box-w2 back w-33 text-center teen-section">
                              <span className="odd d-block card-number">1</span>
                              <div>
                                <div className="ubook text-danger">
                                  <b style={{ color: "#006400" }}>0</b>
                                </div>
                              </div>
                            </td>
                            <td className="box-w2 back w-33 text-center teen-section">
                              <span className="odd d-block card-number">2</span>
                              <div>
                                <div className="ubook text-danger">
                                  <b style={{ color: "#006400" }}>0</b>
                                </div>
                            ...
                            <td className="box-w2 back w-33 text-center teen-section">
                              <span className="odd d-block card-number">3</span>
                              <div>
                                <div className="ubook text-danger">
                                  <b style={{ color: "#006400" }}>0</b>
                                </div>
                            ...
                            <td className="box-w2 back w-33 text-center teen-section">
                              <span className="odd d-block card-number">4</span>
                              <div>
                                <div className="ubook text-danger">
                                  <b style={{ color: "#006400" }}>0</b>
                                </div>
                            ...
                            <td className="box-w2 back w-33 text-center teen-section">
                              <span className="odd d-block card-number">5</span>
                              <div>
                                <div className="ubook text-danger">
                                  <b style={{ color: "#006400" }}>0</b>
                                </div>
                          ...
                          <tr className="back bet-info" id="poker-number2">
                            <td className="box-w2 back w-33 text-center teen-section">
                              <span className="odd d-block card-number">6</span>
                              <div>
                                <div className="ubook text-danger">
                                  <b style={{ color: "#006400" }}>0</b>
                                </div>
                            ...
                            <td className="box-w2 back w-33 text-center teen-section">
                              <span className="odd d-block card-number">7</span>
                              <div>
                                <div className="ubook text-danger">
                                  <b style={{ color: "#006400" }}>0</b>
                                </div>
                            ...
                            <td className="box-w2 back w-33 text-center teen-section">
                              <span className="odd d-block card-number">8</span>
                              <div>
                                <div className="ubook text-danger">
                                  <b style={{ color: "#006400" }}>0</b>
                                </div>
                            ...
                            <td className="box-w2 back w-33 text-center teen-section">
                              <span className="odd d-block card-number">9</span>
                              <div>
                                <div className="ubook text-danger">
                                  <b style={{ color: "#006400" }}>0</b>
                                </div>
                            ...
                            <td className="box-w2 back w-33 text-center teen-section">
                              <span className="odd d-block card-number">0</span>
                              <div>
                                <div className="ubook text-danger">
                                  <b style={{ color: "#006400" }}>0</b>
                                </div>
