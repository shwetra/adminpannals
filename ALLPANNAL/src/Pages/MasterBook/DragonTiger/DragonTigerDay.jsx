        ...
        <div className="container-fluid">
          ...
          <div className="card bg-info-subtle shadow-none position-relative overflow-hidden mb-md-4 mb-3">
            <div className="card-body d-flex align-items-md-center justify-content-between p-md-4 p-3 flex-md-row flex-column">
              <h5 className="fw-bold mb-0">1 Day Dragon Tiger</h5>
          ...
          <div className="row">
            <div className="col-md-8">
              ...
              <div className="mb-5 mt-2">
                    ...
                    <div className="card-content">
                      <div className="row">
                        ...
                        <div className="col-md-3 col-4 text-center">
                          <h6>
                            <small className="fw-bold mb-1">BACK</small>
                          </h6>
                        </div>
                        <div className="col-md-3 col-4 text-center">
                          <h6>
                            <small className="fw-bold mb-1">LAY</small>
                          </h6>
                        </div>
                      </div>
                      <div className="row">
                        ...
                        <div className="col-md-3 col-4">
                          <button className="text-uppercase btn w-100 rounded-1 back">
                            <b className="text-dark">1.98</b>
                          </button>
                        </div>
                        <div className="col-md-3 col-4">
                          <button
                            className="text-uppercase btn w-100 rounded-1 lay showbet-action"
                            data-side="LAY"
                            data-index={0}
                          >
                      ...
                      <div className="row">
                        ...
                        <div className="col-md-3 col-4">
                          <button className="text-uppercase btn w-100 rounded-1 lay showbet-action">
                            <b className="text-dark">0.00</b>
                          </button>
                        </div>
                      </div>
                ...
                {/* last result */}
                <div className="card mt-1 mb-5 overflow-hidden">
