        ...
        <div className="container-fluid">
          ...
          <div className="card bg-info-subtle shadow-none position-relative overflow-hidden mb-md-4 mb-3">
            <div className="card-body d-flex align-items-md-center justify-content-between p-md-4 p-3 flex-md-row flex-column">
              <h5 className="fw-bold mb-0">20-20 Dragon Tiger</h5>
                  ...
                  <div className="card-body p-3">
                    <div className="bg-light rounded p-2 mb-3">
                      <div className="row custom-row">
                        <div className="col-md-9">
                          <div className="row">
                            <div className="col-md-5 col-6 custom-col">
                              <div className="casino-box-row">
                                <div className="w-100 text-center mb-1 pr">
                                  <b>2.00</b>
                                </div>
                                <div className="poker6box suspended">
                                  <div className="casino-nation-name justify-content-center">
                                    <h6 className="mb-0 text-white fw-bold ps-1">
                                      <small>Under Price</small>
                                    </h6>
                                  </div>
                                </div>
                                <div className="w-100 text-center mb-1 pr">
                                  <b className="text-red">0</b>
                                </div>
                              </div>
                            </div>
                    ...
                    <div className="row custom-row">
                      <div className="col-6 custom-col">
                        <div className="bg-light rounded p-2 mb-3">
                          <h6 className="text-center fw-bold">DRAGON</h6>
                          <div className="row custom-row">
                      ...
                      <div className="col-6 custom-col">
                        <div className="bg-light rounded p-2 mb-3">
                          <h6 className="text-center fw-bold">TIGER</h6>
                          <div className="row custom-row">
                            <div className="col-md-6 custom-col">
                              <div className="casino-box-row">
                                <div className="w-100 text-center mb-1 pr">
                    ...
                    <div className="row custom-row">
                      <div className="col-md-6 custom-col">
                        <div className="bg-light rounded p-2 mb-0">
                          <div className="w-100 text-center mb-1 pr">
                            <b>Dragon 12.00</b>
                          </div>
                          <div className="text-center card-seven">
                            <div className="card-image showbet-action">
                              <div className="">
                                <img
                            ...
                            <div className="card-image showbet-action">
                              <div className="">
                                <img
                                  src="https://indiaexch7.com/img/cards/andar_bahar1/2.jpg"
                                  width={"45px"}
                                />
                              </div>
                              <div className="ubook text-danger">
                            ...
                            <div className="card-image showbet-action">
                              <div className="">
                                <img
                                  src="https://indiaexch7.com/img/cards/andar_bahar1/3.jpg"
                                  width={"45px"}
                                />
                              </div>
                              <div className="ubook text-danger">
                            ...
                            <div className="card-image showbet-action">
                              <div className="">
                                <img
                                  src="https://indiaexch7.com/img/cards/andar_bahar1/4.jpg"
                                  width={"45px"}
                                />
                              </div>
                              <div className="ubook text-danger">
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="text-center mb-3">
                <img
                  src="https://indiaexch7.com/img/cards1/3HH.png"
                  width={50}
                  alt=""
                />
                <img
                  src="https://indiaexch7.com/img/cards1/8CC.png"
                  width={50}
                  alt=""
                />
              </div>
              <h6 className="fw-bold text-center">
                <span style={{ color: "#04d604" }}>Result:</span> Tiger
              </h6>
              <h6 className="text-center">
                <small>
                  Dragon :Red || Odd || Card3
                  <br />
                  Tiger :Black || Even || Card8
                </small>
              </h6>
            </div>
          </div>
