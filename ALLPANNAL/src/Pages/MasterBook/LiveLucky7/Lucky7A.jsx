        ...
        <div className="container-fluid">
          ...
          <div className="card bg-info-subtle shadow-none position-relative overflow-hidden mb-md-4 mb-3">
            <div className="card-body d-flex align-items-md-center justify-content-between p-md-4 p-3 flex-md-row flex-column">
              <h5 className="fw-bold mb-0">Bollywood Casino</h5>
                  ...
                  <div className="card-body p-3">
                    <div className="bg-light rounded p-2 mb-3">
                      <div className="row custom-row">
                        ...
                        <div className="col-2 text-center custom-col">
                          <p></p>
                          <img
                    ...
                    <div className="bg-light rounded p-2 mb-0">
                      <div className="text-center card-seven">
                        <div className="me-1 card-image showbet-action">
                          <div className="">
                            <img
                              src="https://indiaexch7.com/img/cards/andar_bahar/1.jpg"
                              width={"45px"}
                            />
                          </div>
                        ...
                        <div className="me-1 card-image showbet-action">
                          <div className="">
                            <img
                              src="https://indiaexch7.com/img/cards/andar_bahar/13.jpg"
                              width={"45px"}
                            />
                          </div>
                          <div className="ubook text-danger">
          ...
          <div className="modal-content">
            ...
            <div className="modal-body">
              ...
              <div className="text-center mb-3">
                <img
                  src="https://indiaexch7.com/img/cards1/6CC.png"
                  width={50}
                  alt=""
                />
              </div>
