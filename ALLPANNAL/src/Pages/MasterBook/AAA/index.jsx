        ...
        <div className="container-fluid">
          ...
          <div className="card bg-info-subtle shadow-none position-relative overflow-hidden mb-md-4 mb-3">
            <div className="card-body d-flex align-items-md-center justify-content-between p-md-4 p-3 flex-md-row flex-column">
              <h5 className="fw-bold mb-0">Amar Akbar Anthony</h5>
            ...
            <div className="col-md-8">
              ...
              <div className="mb-5 mt-2">
                      ...
                      <div className="row custom-row">
                        <div className="col-md-4 custom">
                          <div className="text-center">
                            <h6 className="mb-1 fw-bold">
                              <small>
                                <span className="text-red">A.</span>Amar
                              </small>
                            </h6>
                          </div>
                          <div className="d-flex gap-2 ">
                            ...
                            <button className="text-uppercase btn w-100 rounded-1 lay">
                        ...
                        <div className="col-md-4 custom">
                          <div className="text-center">
                            <h6 className="mb-1 fw-bold">
                              <small>
                                <span className="text-red">B.</span>Akbar
                              </small>
                            </h6>
                          </div>
                          <div className="d-flex gap-2 ">
                        ...
                        <div className="col-md-4 custom">
                          <div className="text-center">
                            <h6 className="mb-1 fw-bold">
                              <small>
                                <span className="text-red">C.</span>Anthony
                              </small>
                            </h6>
                          </div>
                          <div className="d-flex gap-2 ">
                ...
                <div className="card overflow-hidden my-3">
                  <div className="card-body p-3">
                    <div className="row custom-row">
                      <div className="col-md-4 col-6 custom-col">
