        ...
        <div className="container-fluid">
          ...
          <div className="card bg-info-subtle shadow-none position-relative overflow-hidden mb-md-4 mb-3">
            <div className="card-body d-flex justify-content-between p-md-4 p-3">
              <h5 className="fw-bold mb-0">Live Poker</h5>
            </div>
          </div>

          <div className="row custom-row">
            <div className="col-md-4 col-6 custom-col mb-2 pb-1">
              <Link to="/MasterBook/Pocker/Details">
                <img
                  src="https://indiaexch7.com/img/Poker6.jpg"
            ...
            <div className="col-md-4 col-6 custom-col mb-2 pb-1">
              <Link to="/MasterBook/Pocker/Details">
                <img
                  src="https://indiaexch7.com/img/Poker20.jpg"
                  className="img-fluid w-100 rounded"
                  alt=""
                />
              </Link>
            ...
            <div className="col-md-4 col-6 custom-col mb-2 pb-1">
              <Link to="/MasterBook/Pocker/Details">
                <img
                  src="https://indiaexch7.com/img/Poker.jpg"
                  className="img-fluid w-100 rounded"
                  alt=""
                />
              </Link>
