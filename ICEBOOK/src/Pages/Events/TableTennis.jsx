          ...
          <div className="detail-page-container">
            <div className="center-main-container">
              <div className="center-content">
                <div className="game-header sport8">
                  <span className="game-header-name">GB &gt; DONCASTER</span>
                  <div>
                    <span>20/06/2024 01:48:00</span>
                  </div>
                </div>
                  ...
                  <div className="market-2">
                    <div className="bet-table">
                      ...
                      <div
                        ...
                        className="bet-table-body collapse show suspendedfull"
                      >
