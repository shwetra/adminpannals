...
function DragonTigert20() {
  return (
    <>
      <div className="main-content">
        <div className="page-content">
          <div className="detail-page-container">
            <div className="center-main-container dt20">
                    ...
                    <div className="text-right w-100 pr">
                      <div className="float-right">
                        ...
                        <div id="demo1" className="collapse icon-range">
                          Range:<span>100</span>-<span>3L</span>
                        </div>
                      </div>
                    </div>
                    <div className="dtobx-top">
                      <div className="dragon-box">
                        ...
                        <div className="text-center">
                          ...
                          <span className="d-block casino-book book-black">
                            0
                          </span>
                        </div>
                      </div>
