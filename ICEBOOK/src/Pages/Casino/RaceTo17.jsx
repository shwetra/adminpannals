      ...
      <div className="main-content">
        <div className="page-content">
          <div className="detail-page-container">
            <div className="center-main-container raceto17">
                        ...
                        <div className="casino-box-row">
                          ...
                          <div className="casino-bl-box">
                            <div className="back casino-bl-box-item">
                              <span className="casino-box-odd">1.34</span>
                            </div>
                            <div className="lay casino-bl-box-item">
                              <span className="casino-box-odd">1.37</span>
                            </div>
                          </div>
                      ...
                      <div className="col-md-3 col-6">
                        <div className="casino-box-row">
                          ...
                          <div className="casino-bl-box">
                            ...
                            <div className="lay casino-bl-box-item">
                              <span className="casino-box-odd">3.38</span>
                            </div>
                          </div>
                          <div className="casino-nation-name book-black">0</div>
                        </div>
