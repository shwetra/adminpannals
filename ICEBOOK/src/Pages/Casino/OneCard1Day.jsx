...
function OneCard1Day() {
  return (
    <>
      <div className="main-content">
        <div className="page-content">
          <div className="detail-page-container">
            <div className="center-main-container teen1oneday">
                    ...
                    <div className="teen1daycasino-container">
                      <div className="teen1dayleft">
                        <div className="seven-up-down-box">
                          <div className="up-box suspended">
                            <div className="up-down-book book-black">0</div>
                            <div className="text-right">
                              <div className="up-down-odds">2</div>
                              <span>DOWN</span>
                            </div>
                          </div>
                          <div className="down-box suspended">
                            <div className="up-down-book book-black">0</div>
