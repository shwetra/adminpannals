      ...
      <div className="main-content">
        <div className="page-content">
          <div className="detail-page-container">
            <div className="center-main-container superover2">
              <div className="center-content">
                <div className="game-header">
                  <span className="game-header-name">
                    ND VS ENG SUPER OVER2
                  </span>
                  <div>
                    <span>Round ID: 7358141704</span>
                  </div>
                </div>
                ...
                <div className="">
                  <div className="row row5 mx-0 px-1">
                    ...
                    <div className="col-xl-10 pe-0 ps-ms-auto ps-0">
                      <div className="casino-video mt-md-0 mt-1">
                        ...
                        <div className="bet-table-row">
                          <div className="text-right nation-name">
                            <span className="max-bet">
                              <span title="Min:100 Max:3L">Min:100 Max:3L</span>
                            </span>
                          </div>
                          <div className="back bl-title">Back</div>
                          <div className="lay bl-title">Lay</div>
                        </div>
                    ...
                    <div className="bet-table">
                      ...
                      >
                        ...
                        <div className="fancy-tripple">
                          <div className="bet-table-row">
                            <div className="nation-name flex-column align-items-start">
