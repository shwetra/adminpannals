...
function OneCardMeter() {
  return (
    <>
      <div className="main-content">
        <div className="page-content">
          <div className="detail-page-container">
            <div className="center-main-container one-card-meter">
                  ...
                  <div className="casino-detail">
                    <div className="meter-btns">
                      <div className="meter-btn">
                        ...
                        <div className="meter-btn-box">
                          <button className="btn btn-fighter-1">
                            Fighter A
                            <img
                              src="https://wver.sprintstaticdata.com/v50/static/admin/img/fight.png"
                              alt="Fight"
                            />
                          </button>
                        </div>
                        <div className="book-green text-center">
                          <b className="book-black">0</b>
                        </div>
                      </div>
                      <div className="meter-btn">
                        <div className="text-right min-max">
                        ...
                        <div className="meter-btn-box">
                          <button className="btn btn-fighter-2">
                            <img
                              src="https://wver.sprintstaticdata.com/v50/static/admin/img/fight.png"
                              alt="Fight"
                            />
