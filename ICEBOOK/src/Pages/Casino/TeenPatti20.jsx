...
function TeenPatti20() {
  return (
    <>
      <div className="main-content">
        <div className="page-content">
          <div className="detail-page-container">
            <div className="center-main-container teenpatti20">
                      ...
                      <div className="teen20left">
                        ...
                        <div className="casino-rb-box-container mb-3">
                          <div className="casino-rb-box blackcontainer">
                            <div className="casino-rb-box-player blackbox back ">
                          ...
                          <div className="casino-rb-box redcontainer">
                            <div className="casino-rb-box-player redbox back ">
                              <div>
                                <img src="https://wver.sprintstaticdata.com/v50/static/front/img/cards/heart.png" />
                                <img
                                  src="https://wver.sprintstaticdata.com/v50/static/front/img/cards/diamond.png"
                            ...
                            <div className="card-body" style={{ padding: 10 }}>
                              <table className="table table-bordered rules-table">
                                <tbody>
                                  ...
                                  <tr>
                                    <td width="60%">Pair</td> <td>1 TO 1</td>
                                  </tr>
                                  <tr>
                                    <td width="60%">Flush</td> <td>1 TO 4</td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                    <td width="60%">Trio</td> <td>1 TO 30</td>
                                  </tr>
                                  <tr>
